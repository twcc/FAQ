...
- Q1. 請問在台灣杉二號 (命令列介面)如何去部屬環境執行我的程式?
- Q2. 台灣杉二號 (命令列介面) 是否可使用跨節點的運算？
- Q3. 使用跨節點運算，節點是系統自動選取或需手動選取？
- Q4. 為什麼我執行任務索取多個 CPU 資源會發生錯誤？
- Q1. 可以協助我安裝套件嗎？
- Q2. 排程系統 Slurm 是什麼？
- Q3. 是否可以在台灣衫二號上安裝 Rclone 軟體同步工具？
- Q4. 台灣杉二號有支援 Nvidia 的 CUDA 運算架構嗎?
- Q5. 為什麼有些套件在開發型容器可以使用，但在台灣杉二號不能，兩者不是共用高速儲存空間 (HFS) 嗎?
