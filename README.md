...
### [雲端檔案服務(CFS)](儲存服務/雲端檔案服務(CFS).md) (3) 
- Q1. 上傳新版本的檔案，原先置放於冷儲存區的檔案卻轉移到熱儲存區？
- Q2. 為何無法從會員中心的資源用量紀錄中查詢CFS的用量資訊？
- Q3. 資料夾內會有兩個相同檔名的檔案？
...
- Q4. 如何將檔案分享給其他用戶？
- Q5. 如何增購高速檔案系統空間？
- Q6. 請問高速檔案系統的 IP 位置為何？
- Q7. 高速檔案系統畫面顯示快用滿，要如何知道是哪些檔案佔據儲存空間？
- Q8. 增購高速檔案系統空間後多久生效？
- Q9. 已刪除高速檔案系統內資料，為何在儲存與資源用量頁面中的已使用容量並未減少？
## [產品與平台](產品與平台)
...
- Q2. 高速檔案系統 (HFS)、虛擬磁碟服務 (VDS) 、雲端物件儲存服務 (COS)及雲端檔案儲存(CFS)有什麼不同？
...
## [運算服務](運算服務)
### [台灣杉二號(命令列介面)(TWNIA2)](運算服務/台灣杉二號(命令列介面)(TWNIA2).md) (17) 
...
### [虛擬運算服務(VCS)](運算服務/虛擬運算服務(VCS).md) (46) 
...
- Q7. 想了解2022/11/25前建立的虛擬運算個體系統碟收費方式？
- Q8. 停止虛擬運算個體時系統碟會不會計費?
