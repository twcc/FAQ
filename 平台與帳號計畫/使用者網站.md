...
當您在創建或啟動虛擬運算個體、卸載磁碟或是使用容器任務時出現以下錯誤訊息：
...
此兩種身分會有使用權限的差別，權限各功能差異請查看[<ins>此文件</ins>](https://man.twcc.ai/@twccdocs/role-main-zh/https%3A%2F%2Fman.twcc.ai%2F%40twccdocs%2Frole-overview-zh)。
