...
:::spoiler Q15. 忘記Windows虛擬運算個體登入密碼該怎麼處理？

:::info

Windows虛擬運算個體登入密碼為您在建立虛擬運算個體時所設定，請務必妥善自行保存您的密碼，如果忘記密碼請刪除該虛擬運算個體並重新建立。
如須保存原本虛擬運算個體的資料與配置，請先對該台虛擬運算個體進行快照，並利用該快照建立新的虛擬運算個體。
:::

:::spoiler Q16. 遺失Linux虛擬運算個體的金鑰該怎麼處理？

:::info

Linux虛擬運算個體金鑰為您在建立虛擬運算個體時所建立，請務必下載並妥善自行保存您的金鑰，如果遺失金鑰請刪除該虛擬運算個體並重新建立。
如須保存原本虛擬運算個體的資料與配置，請先對該台虛擬運算個體進行快照，並利用該快照建立新的虛擬運算個體。
:::
