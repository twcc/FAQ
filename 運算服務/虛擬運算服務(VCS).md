...
:::
:::spoiler Q4. 為什麼我在建立虛擬運算個體時，母錢包與子錢包皆有額度，卻出現`計畫資源已用盡，無法創建資源`的訊息？

:::info

每個計劃皆有固定的cpu上限數量，出現該訊息代表您的cpu數量已經達到上限，建議您將不需要用到或是較少用到的虛擬運算個體製作成快照以利未來重建，或是直接將該台虛擬運算個體進行刪除，釋放出cpu數量。
...
:::spoiler Q2. 請問要如何知道虛擬運算服務個體網路流量狀態？ 
