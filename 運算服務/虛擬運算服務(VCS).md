...
:::spoiler Q6. 使用虛擬運算個體時，對網路卡設定進行更改，導致無法連線該怎麼處理?

:::info

我們強烈不建議您，對虛擬運算個體的網路卡設定進行更改，因此當您在操作或是部署時，請留意不要更動網路卡設定。
如果有無法連線虛擬運算個體的情形，請詳述情況與虛擬運算個體資訊，寄發 e-mail 至 isupport@twcc.ai，技術團隊將協助您處理。
