...
此情況產生累似的錯誤訊息有很多種，但是都與lock檔有關的錯誤
訊息，解決方法為將此lock檔案刪除後，在執行您要執行的任務。

:::

:::spoiler Q10. 請問虛擬運算服務個體有沒有支援WSL?

:::info

虛擬運算服務體有提供Linux的映像檔，若您有此需求建議選用相關的映像檔來開啟虛擬運算個體。
若您必須要使用WSL，我們的虛擬運算個體可以讓使用者自行安裝WSL，並進行您的工作。
